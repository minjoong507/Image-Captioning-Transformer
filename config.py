...
class BasicOption:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--annotations_path', default='data/annotations/captions_train2017.json', type=str)
        self.parser.add_argument('--img_path', default='data/train2017/', type=str, help='image path')
        ...
        self.parser.add_argument('--is_train', default=True, type=str)
        ...
        self.parser.add_argument('--vocab_path', default='data/vocab.pickle', type=str)
        self.parser.add_argument('--vocab_size', default=None, type=int)
        self.parser.add_argument('--visual_feature_path', default='data/visual_feature_train.pickle', type=str)
        self.parser.add_argument('--save_step', default=1000, type=int)
        self.parser.add_argument('--coco_idx_path', default='data/train_coco_idx.npy', type=str)
        ...
        self.parser.add_argument('--device', type=int, default=0, help='0 is gpu, -1 is cpu')
